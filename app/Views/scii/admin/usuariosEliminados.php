            ...
            <div class="flex shadow-2xl" style="min-height: 18rem;">
                <div class="sm:w-1/5 w-2/5 overflow-auto bg-gray-100">
                    ...
                    <div class="mt-2 px-5">
                        ...
                        <a href="<?php echo base_url().'/administrador/usuariosEliminados';?>" class="pl-4 mb-1 flex place-items-center text-emerald-600/100"><i class="fa-solid fa-user-pen pr-1"></i>
                            Usuarios Eliminados
                        </a>
                    </div>
                </div>
                            ...
                            <div class="overflow-x-auto">
                                <div class="inline-block min-w-full align-middle">
                                    <div class="overflow-hidden m-2 ">
                                        <table id="eliminados" class="text-sm text-gray-500 whitespace-nowrap min-w-full divide-y divide-gray-200">
  ...
  <script>
    $(document).ready( function () {
        $('#eliminados').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo base_url(); ?>/administrador/getUsuariosEliminados',
            "language": {
                "decimal": ",",
                "thousands": ".",
