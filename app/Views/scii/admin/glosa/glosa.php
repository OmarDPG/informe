        ...
        <div class="flex shadow-2xl" style="min-height: 18rem;">
            <div class="sm:w-1/5 w-1/5 overflow-auto bg-gray-100">
                ...
                <div class="mt-2 px-5 border-b-2">
                    ...
                    <a href="<?php echo base_url() . '/administrador/glosa'; ?>" class="pl-4 mb-1 flex place-items-center text-emerald-600/100"><i class="fa-solid fa-file pr-1"></i>
                    ...
                    <table class="table table-bordered sizeFontTable">
                        <tbody>
                            <tr>
                                ...
                                <td class="pt-4" tabindex="43"><a href="<?php echo base_url() . '/administrador/glosas'; ?>" class="pl-4 mb-1 flex place-items-center">
            ...
            <div class="w-full sm:w-4/5 mx-auto bg-white shadow-lg">
                <section class="container mx-auto px-6 py-6">
                    <form action="<?= base_url('administrador/solicitarGlosa') ?>"
                        method="post"
                           ...
                           block w-full p-2.5 transition"
                                ...
                                for ($year = $startYear; $year <= $currentYear; $year++) {
                                    for ($quarter = 1; $quarter <= 4; $quarter++) {
                                        $period = "Etapa$quarter $year";
                                        $value = "$year-Etapa$quarter";
                        ...
                        <div class="flex flex-col justify-between bg-gray-50 border rounded-lg p-4">
                            <p class="text-sm text-gray-700 leading-snug">
                                Solicitar a todos los usuarios la
                                <span class="font-semibold text-emerald-700">
                                    Glosa del Informe de Gobierno <?php echo date('Y'); ?>.
                                </span>
                            </p>
                           ...
                           transition">
                                Solicitar Glosa del Informe de Gobierno <?php echo date('Y'); ?>
                            </button>
                        </div>

                        <!-- Finalizar -->
                        <div class="flex items-center justify-center">
                            <a href="<?= base_url('Administrador/finalizarGlosa') ?>"
                                class="inline-flex items-center justify-center gap-2
                          text-white bg-red-700 hover:bg-red-800
                          focus:ring-4 focus:ring-red-300
                          font-medium rounded-lg text-sm px-6 py-3
                          transition shadow">
                                Finalizar Glosa del Informe de Gobierno <?php echo date('Y'); ?>
                            </a>
                        </div>
