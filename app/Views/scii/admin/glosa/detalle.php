        ...
        <header class="flex items-center h-10 px-4 bg-gray-900 text-white rounded-t-lg">
            <div>
                <div class="flex pl-3 w-full">
                    ...
                    <span class="pl-2 pt-0.5 font-normal"><?php echo $current ?? 'Evidencia / Glosa del Informe de Gobierno'; ?></span>
                </div>
            </div>
                    ...
                    <div class="flex flex-col lg:flex-row gap-6">
                                    ...
                                    <div class="max-w-4xl mx-auto">
                                        <form method="POST" class="space-y-6" action="<?php echo base_url(); ?>/administrador/enviarNotificacionesGlosa/<?= esc($glosa_id ?? '') ?>" enctype="multipart/form-data">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="relative">
                                                        <select
                                                            ...
                                                            <option value="" disabled <?= empty($glosa['id_alineacion_ped']) ? 'selected' : '' ?>>Seleccione una opción</option>
                                                            <?php foreach ($lineas as $l): ?>
                                                                <option value="<?= $l['id'] ?>" <?= (isset($glosa['id_alineacion_ped']) && $glosa['id_alineacion_ped'] == $l['id']) ? 'selected' : '' ?>>
                                                                    <?= esc($l['codigo']) ?> —
                                                                    <?= esc($l['descripcion']) ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="relative">
                                                        <select
                                                            ...
                                                            required
                                                            class="block w-full appearance-none rounded-lg border border-gray-300 bg-white px-4 py-3 pr-10 text-sm text-gray-900 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500 focus:outline-none transition duration-200">
                                                            <option value="" disabled <?= empty($glosa['orden_prioridad']) ? 'selected' : '' ?>>Seleccione una opción</option>
                                                            <?php for ($i = 1; $i <= 10; $i++): ?>
                                                                <option value="<?= $i ?>"
                                                                    <?= (isset($glosa['orden_prioridad']) && (int)$glosa['orden_prioridad'] === $i) ? 'selected' : '' ?>>
                                                                    <?= $i ?>
                                                                </option>
                                                            <?php endfor; ?>
                                                        </select>
                                            ...
                                            <div>
                                                ...
                                                <div class="relative" style="display:grid; grid-template-columns: 95% 5%; gap: 0.5rem;">
                                                    <input
                                                        ...
                                                        maxlength="100"
                                                        required
                                                        value="<?= esc($glosa['introduccion'] ?? '') ?>"
                                                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 block w-full p-3 pr-12 transition duration-200"
                                                        placeholder="Ingrese el introduccion de la glosa">
                                                    <button
                                                        type="button"
                                                        class="comment-btn absolute right-3 top-1/2 -translate-y-1/2 text-xl text-gray-400 hover:text-green-600 transition"
                                                        data-field="introduccion"
                                                        data-label="Introducción al tema"
                                                        aria-label="Agregar comentario al campo Introduccion al tema">
                                                        <i class="fa-solid fa-comment-dots"></i>
                                                        <span class="comment-indicator hidden absolute -top-1 -right-1 w-2 h-2 bg-red-500 rounded-full"></span>
                                                    </button>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="relative" style="display:grid; grid-template-columns: 95% 5%; gap: 0.5rem;">
                                                    <textarea
                                                        ...
                                                        placeholder="Ingrese el desarrollo del resultado"><?= esc($glosa['desarrollo'] ?? '') ?></textarea>
                                                    <button
                                                        type="button"
                                                ...
                                                <div>
                                                    ...
                                                    <div class="relative">
                                                        <select
                                                            ...
                                                            required
                                                            class="block w-full appearance-none rounded-lg border border-gray-300 bg-white px-4 py-3 pr-10 text-sm text-gray-900 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500 focus:outline-none transition duration-200">
                                                            <option value="" disabled <?= empty($glosa['id_alineacion_programa_derivado']) ? 'selected' : '' ?>>Seleccione una opción</option>
                                                            <?php if ($unidad['id_unidad'] == 1): ?>
                                                                <?php foreach ($lineasAgua as $la): ?>
                                                                    <option value="<?= $la['id'] ?>" <?= (isset($glosa['id_alineacion_programa_derivado']) && $glosa['id_alineacion_programa_derivado'] == $la['id']) ? 'selected' : '' ?>>
                                                            ...
                                                            <?php elseif ($unidad['id_unidad'] != 1): ?>
                                                                <?php foreach ($lineasSocioambiental as $ls): ?>
                                                                    <option value="<?= $ls['id'] ?>" <?= (isset($glosa['id_alineacion_programa_derivado']) && $glosa['id_alineacion_programa_derivado'] == $ls['id']) ? 'selected' : '' ?>>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="relative">
                                                        <select
                                                            ...
                                                            required
                                                            class="block w-full appearance-none rounded-lg border border-gray-300 bg-white px-4 py-3 pr-10 text-sm text-gray-900 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500 focus:outline-none transition duration-200">
                                                            <option value="" disabled <?= empty($glosa['id_alineacion_ods']) ? 'selected' : '' ?>>Seleccione una opción</option>
                                                            <?php foreach ($odsTemas as $ods): ?>
                                                                <option value="<?= $ods['id_tema'] ?>" <?= (isset($glosa['id_alineacion_ods']) && $glosa['id_alineacion_ods'] == $ods['id_tema']) ? 'selected' : '' ?>>
                                                                    <?= $ods['codigo_meta'] ?> -
                                                                    <?= $ods['tema'] ?>
                                            ...
                                            <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200" style="gap: 1em;">
                                                ...
                                                <a href="<?= base_url('administrador/aprobarGlosa/'.$glosa['id_glosa_gobierno']) ?>"
                        ...
                        <aside id="sidebar" class="">
                            ...
                            <div class="p-4 space-y-3 max-h-96 overflow-y-auto">
                                ...
                                <?php if (!empty($glosasUnidad)): ?>
                                    <?php foreach ($glosasUnidad as $inf): ?>
