        ...
        <div class="flex shadow-2xl" style="min-height: 18rem;">
            ...
            <div class="sm:w-4/5 w-4/5 bg-gray-50">
                <section class="container mx-auto">
                    <div class="">
                        <form action="<?php echo base_url('administrador/solicitarEvaluacion') ?>" method="post" class="grid md:grid-cols-2 lg:grid-cols-3 md:gap-6 mt-6 m-4">
                            <div class="relative z-0 w-full mb-2 group">
                                <select name="year" id="year" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                                    <option value="n">Selecciona un periodo</option>
                                    <?php
                                    $startYear = 2024;
                                    $currentYear = date('Y');
                                    ...
                                    for ($year = $startYear; $year <= $currentYear; $year++) {
                                        for ($quarter = 1; $quarter <= 2; $quarter++) {
                                            $period = "S$quarter $year";
                                            $value = "$year-S$quarter";
                            ...
                            <div id="status" class="relative z-0 w-full mb-2 group">
                                <div>Solicitar a todos los usuarios la <b>Evaluacion al Desempeño</b></div>
                                <button class="mt-3 text-white bg-green-800 hover:bg-emerald-700 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Solicitar evaluacion</button>
                            </div>
                            <div class="m-4 flex flex-row gap-8 items-center">
                                <a href="<?= base_url('Administrador/finalizarEvaluacion') ?>" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">Finalizar Evaluacion</a>
                            </div>
                        </form>
                    </div>
                </section>
