                            ...
                            <div class="inline-block min-w-full align-middle">
                                <div class="overflow-hidden m-2 ">
                                    <div class="m-4 flex flex-row gap-8 items-center">
                                        <a href="<?= base_url('Administrador/exportarExcel') ?>" class="text-white bg-emerald-700 hover:bg-emerald-800 focus:ring-4 focus:ring-emerald-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-emerald-600 dark:hover:bg-emerald-700 focus:outline-none dark:focus:ring-emerald-800">Exportar a Excel</a>
                                        <p>Registro de Evaluacion</p>
                                    </div>
                                    <table id="evaluaciones" class="text-sm text-gray-500 whitespace-nowrap min-w-full divide-y divide-gray-200">
                                        <thead class="bg-gray-50">
                                            <tr>
                                                ...
                                                <!-- <th scope="col" class="px-4 py-2 text-sm font-normal rtl:text-right text-gray-500 dark:text-gray-400 text-center">
                                                    Respuesta
                                                </th> -->
                                            </tr>
                                        </thead>
...
<script>
    $(document).ready(function() {
        $('#evaluaciones').DataTable({
            ...
            serverSide: true,
            ajax: {
                url:'<?php echo base_url(); ?>/administrador/obtenerEvaluacionesAjax',
                type: 'POST'
            },
            columns: [
                { data: 'usuario' },
                ...
                { data: 'apellido_m' },
                { data: 'descripcion' },
                { data: 'estado', "orderable": false },  // Esta columna debe mapear el estado de la evaluación
                // { data: 'tipo' }  // Esta columna debe mapear el tipo de evaluación
            ],
