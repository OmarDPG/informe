<!-- <div class="p-8 rounded-lg">
    <section>
        ...
        <header class="flex items-center h-10 px-4 bg-gray-900 text-white rounded-t-lg">
            <div>
                <div class="flex pl-3 w-full">
                    ...
                    <span class="pl-2 pt-0.5 font-normal">Detalle del Informe</span>
                </div>
            </div>
            <a href="<?php echo base_url(); ?>/administrador/informes" class="w-5 h-5 bg-red-500 rounded-md ml-auto text-white text-lg font-light hover:bg-blue-gray-light hover:cursor-pointer focus:outline-none">
        ...
        <div class="bg-white shadow-2xl rounded-b-lg">
            <div class="px-6 py-4 border-b">
                <a href="<?php echo base_url(); ?>/administrador/informes" class="inline-flex items-center text-emerald-600 hover:text-emerald-800 font-medium">
            ...
            <div class="p-6">
                <div class="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-lg p-6 mb-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <div class="space-y-2">
                                <p class="text-lg text-gray-700">
                                    ...
                                    <?php echo isset($unidad) ? esc($unidad['descripcion']) : 'Secretaría de Educación Pública'; ?>
                                </p>
                                <div class="flex items-center gap-4">
                                    <p class="text-gray-700">
                                        <span class="font-semibold">Determinante:</span> 
                                        <?php echo isset($unidad) ? esc($unidad['determinante']) : 'SEP'; ?>
                                    </p>
                                    <p class="text-gray-700">
                                        <span class="font-semibold">Año:</span> 
                                        <?php echo isset($anio) ? esc($anio) : '2024'; ?>
                                    </p>
                                    <p class="text-gray-700">
                                        <span class="font-semibold">Etapa:</span> 
                                        <?php echo isset($etapa) ? esc($etapa) : '1'; ?>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="text-right">
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-green-100 text-green-800">
                                ...
                                <?php echo isset($informe['estado']) ? ucfirst(esc($informe['estado'])) : 'Completado'; ?>
                            </span>
                            <p class="text-sm text-gray-600 mt-2">
                                <i class="fa-solid fa-calendar mr-1"></i>
                                Fecha: <?php echo isset($informe['fecha']) ? date('d/m/Y', strtotime($informe['fecha'])) : date('d/m/Y'); ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                            <button onclick="showTab('general')" class="tab-button active whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                                <i class="fa-solid fa-info-circle mr-2"></i>
                                Información General
                            </button>
                            <button onclick="showTab('archivos')" class="tab-button whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                                <i class="fa-solid fa-file-pdf mr-2"></i>
                                Archivos Adjuntos
                            </button>
                            <button onclick="showTab('comentarios')" class="tab-button whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                                <i class="fa-solid fa-comments mr-2"></i>
                                Comentarios
                            </button>
                            <button onclick="showTab('historial')" class="tab-button whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                ...
                <div id="tab-content">
                    <div id="general" class="tab-pane active">
                            ...
                            <div class="bg-gray-50 rounded-lg p-6">
                                ...
                                <div class="space-y-3">
                                    <div class="flex border-b pb-2">
                                        <span class="font-semibold text-gray-700 w-1/3">ID Informe:</span>
                                        <span class="text-gray-600"><?php echo isset($informe['id']) ? esc($informe['id']) : 'INF-2024-001'; ?></span>
                                    </div>
                                    <div class="flex border-b pb-2">
                                        <span class="font-semibold text-gray-700 w-1/3">Tipo:</span>
                                        <span class="text-gray-600">Informe de Gobierno</span>
                                    </div>
                                    <div class="flex border-b pb-2">
                                        <span class="font-semibold text-gray-700 w-1/3">Periodo:</span>
                                        <span class="text-gray-600"><?php echo isset($anio) ? esc($anio) : '2024'; ?></span>
                                    </div>
                                    <div class="flex border-b pb-2">
                                        <span class="font-semibold text-gray-700 w-1/3">Etapa:</span>
                                        <span class="text-gray-600">Etapa <?php echo isset($etapa) ? esc($etapa) : '1'; ?></span>
                                    </div>
                                    <div class="flex border-b pb-2">
                                        <span class="font-semibold text-gray-700 w-1/3">Fecha Creación:</span>
                                        <span class="text-gray-600"><?php echo isset($informe['fecha_creacion']) ? date('d/m/Y', strtotime($informe['fecha_creacion'])) : date('d/m/Y'); ?></span>
                                    </div>
                                    <div class="flex border-b pb-2">
                                        <span class="font-semibold text-gray-700 w-1/3">Última Modificación:</span>
                                        <span class="text-gray-600"><?php echo isset($informe['fecha_modificacion']) ? date('d/m/Y H:i', strtotime($informe['fecha_modificacion'])) : date('d/m/Y H:i'); ?></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <p class="text-gray-600 text-sm leading-relaxed">
                                            <?php echo isset($informe['descripcion']) ? esc($informe['descripcion']) : 'Este informe presenta los resultados y avances obtenidos durante el periodo fiscal correspondiente. Se detallan las acciones implementadas, los logros alcanzados y los retos identificados en el ejercicio de las funciones de la unidad administrativa.'; ?>
                                        </p>
                                    </div>
                                    <div>
                                        <h4 class="font-semibold text-gray-700 mb-2">Objetivos Cumplidos:</h4>
                                        <ul class="list-disc list-inside text-gray-600 text-sm space-y-1">
                                            <li>Implementación de programas estratégicos</li>
                                            <li>Fortalecimiento institucional</li>
                                            <li>Mejora en indicadores de gestión</li>
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div class="bg-blue-50 rounded-lg p-4 text-center">
                                <i class="fa-solid fa-file-pdf text-3xl text-blue-600 mb-2"></i>
                                <p class="text-2xl font-bold text-blue-700">
                                    <?php echo isset($archivos_count) ? esc($archivos_count) : '5'; ?>
                                </p>
                                <p class="text-sm text-gray-600">Archivos Adjuntos</p>
                            </div>
                            <div class="bg-green-50 rounded-lg p-4 text-center">
                                <i class="fa-solid fa-check-circle text-3xl text-green-600 mb-2"></i>
                                <p class="text-2xl font-bold text-green-700">100%</p>
                                <p class="text-sm text-gray-600">Completado</p>
                            </div>
                            <div class="bg-purple-50 rounded-lg p-4 text-center">
                                <i class="fa-solid fa-comments text-3xl text-purple-600 mb-2"></i>
                                <p class="text-2xl font-bold text-purple-700">
                                    <?php echo isset($comentarios_count) ? esc($comentarios_count) : '3'; ?>
                                </p>
                                <p class="text-sm text-gray-600">Comentarios</p>
                            </div>
                            <div class="bg-orange-50 rounded-lg p-4 text-center">
                                <i class="fa-solid fa-eye text-3xl text-orange-600 mb-2"></i>
                                <p class="text-2xl font-bold text-orange-700">
                                    <?php echo isset($informe['vistas']) ? esc($informe['vistas']) : '24'; ?>
                                </p>
                        ...
                        <div class="bg-gray-50 rounded-lg p-6">
                            <div class="flex justify-between items-center mb-4">
                                <h3 class="text-lg font-semibold text-gray-800 flex items-center">
                                    <i class="fa-solid fa-paperclip mr-2 text-emerald-600"></i>
                                    Archivos del Informe
                                </h3>
                                <button class="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg text-sm font-medium">
                            ...
                            <div class="space-y-3">
                                <div class="bg-white border rounded-lg p-4 hover:shadow-md transition flex items-center justify-between">
                                    <div class="flex items-center">
                                        <div class="bg-red-100 rounded-lg p-3 mr-4">
                                            <i class="fa-solid fa-file-pdf text-2xl text-red-600"></i>
                                        </div>
                                        <div>
                                            <h4 class="font-semibold text-gray-800">Informe_Completo_2024.pdf</h4>
                                            <p class="text-sm text-gray-500">2.5 MB • Subido el 15/01/2024</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        ...
                                        <button class="text-emerald-600 hover:text-emerald-800 p-2">
                                ...
                                <div class="bg-white border rounded-lg p-4 hover:shadow-md transition flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <h4 class="font-semibold text-gray-800">Indicadores_Estadisticos.xlsx</h4>
                                            <p class="text-sm text-gray-500">1.8 MB • Subido el 15/01/2024</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <button class="text-blue-600 hover:text-blue-800 p-2">
                                ...
                                <div class="bg-white border rounded-lg p-4 hover:shadow-md transition flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <h4 class="font-semibold text-gray-800">Resumen_Ejecutivo.docx</h4>
                                            <p class="text-sm text-gray-500">850 KB • Subido el 15/01/2024</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <button class="text-blue-600 hover:text-blue-800 p-2">
                    ...
                    <div id="comentarios" class="tab-pane hidden">
                        <div class="bg-gray-50 rounded-lg p-6">
                            <h3 class="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                                <i class="fa-solid fa-comments mr-2 text-emerald-600"></i>
                                Comentarios y Observaciones
                            </h3>
                            
                            <div class="bg-white rounded-lg p-4 mb-6">
                                <textarea class="w-full border border-gray-300 rounded-lg p-3 focus:ring-emerald-500 focus:border-emerald-500" rows="3" placeholder="Escribe un comentario u observación..."></textarea>
                            ...
                            <div class="space-y-4">
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-center justify-between mb-1">
                                                <h4 class="font-semibold text-gray-800">Juan Pérez García</h4>
                                                <span class="text-xs text-gray-500">Hace 2 horas</span>
                                            </div>
                                            <p class="text-sm text-gray-600">Excelente presentación de los resultados. Sería conveniente ampliar la sección de indicadores cualitativos.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white rounded-lg p-4 border-l-4 border-green-500">
                                    <div class="flex items-start">
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-center justify-between mb-1">
                                                <h4 class="font-semibold text-gray-800">María López Sánchez</h4>
                                                <span class="text-xs text-gray-500">Hace 1 día</span>
                                            </div>
                                            <p class="text-sm text-gray-600">Revisado y aprobado. Todos los documentos cumplen con los requisitos establecidos.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-white rounded-lg p-4 border-l-4 border-orange-500">
                                    <div class="flex items-start">
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-center justify-between mb-1">
                                                <h4 class="font-semibold text-gray-800">Carlos Rodríguez Martínez</h4>
                                                <span class="text-xs text-gray-500">Hace 2 días</span>
                                            </div>
                                            <p class="text-sm text-gray-600">Favor de verificar las cifras de la página 12, parece haber una discrepancia con el reporte anterior.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="historial" class="tab-pane hidden">
                        <div class="bg-gray-50 rounded-lg p-6">
                            <h3 class="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                                <i class="fa-solid fa-clock-rotate-left mr-2 text-emerald-600"></i>
                                Historial de Cambios
                            </h3>
                            
                            <div class="relative border-l-2 border-emerald-500 ml-4 space-y-6">
                                <div class="relative pl-8">
                                    <div class="absolute -left-3 top-0 bg-emerald-500 rounded-full p-2">
                                        <i class="fa-solid fa-upload text-white text-xs"></i>
                                    </div>
                                    <div class="bg-white rounded-lg p-4 shadow">
                                        <div class="flex items-center justify-between mb-2">
                                            <h4 class="font-semibold text-gray-800">Informe Cargado</h4>
                                            <span class="text-xs text-gray-500">15/01/2024 - 10:30 AM</span>
                                        </div>
                                        <p class="text-sm text-gray-600">El informe fue cargado al sistema por <span class="font-semibold">Admin Sistema</span></p>
                                    </div>
                                </div>

                                <div class="relative pl-8">
                                    <div class="absolute -left-3 top-0 bg-blue-500 rounded-full p-2">
                                        <i class="fa-solid fa-edit text-white text-xs"></i>
                                    </div>
                                    <div class="bg-white rounded-lg p-4 shadow">
                                        <div class="flex items-center justify-between mb-2">
                                            <h4 class="font-semibold text-gray-800">Informe Modificado</h4>
                                            <span class="text-xs text-gray-500">16/01/2024 - 02:15 PM</span>
                                        </div>
                                        <p class="text-sm text-gray-600">Se actualizaron los anexos estadísticos por <span class="font-semibold">Juan Pérez</span></p>
                                    </div>
                                </div>

                                <div class="relative pl-8">
                                    <div class="absolute -left-3 top-0 bg-green-500 rounded-full p-2">
                                        <i class="fa-solid fa-check text-white text-xs"></i>
                                    </div>
                                    <div class="bg-white rounded-lg p-4 shadow">
                                        <div class="flex items-center justify-between mb-2">
                                            <h4 class="font-semibold text-gray-800">Informe Aprobado</h4>
                                            <span class="text-xs text-gray-500">18/01/2024 - 09:00 AM</span>
                                        </div>
                                        <p class="text-sm text-gray-600">El informe fue aprobado por <span class="font-semibold">María López</span></p>
                                    </div>
                                </div>

                                <div class="relative pl-8">
                                    <div class="absolute -left-3 top-0 bg-purple-500 rounded-full p-2">
                                        <i class="fa-solid fa-paper-plane text-white text-xs"></i>
                                    </div>
                                    <div class="bg-white rounded-lg p-4 shadow">
                                        <div class="flex items-center justify-between mb-2">
                                            <h4 class="font-semibold text-gray-800">Informe Enviado</h4>
                                            <span class="text-xs text-gray-500">18/01/2024 - 04:30 PM</span>
                                        </div>
                                        <p class="text-sm text-gray-600">El informe fue enviado a las autoridades correspondientes por <span class="font-semibold">Sistema</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-8 flex justify-between items-center bg-gray-50 rounded-lg p-4">
                    <div class="flex gap-3">
                        <button class="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2 rounded-lg font-medium">
                    ...
                    <div class="flex gap-3">
                        <button class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-2 rounded-lg font-medium">
